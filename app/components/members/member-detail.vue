        ...
        <div class="flex justify-between">
          ...
          <div class="flex flex-col gap-4 justify-between">
            ...
            <div class="flex flex-col gap-2 self-start">
              ...
              <div class="flex items-center gap-2">
                <div class="h-2 w-2 rounded-full" :class="member?.isActive ? 'bg-green-500' : !member?.isActive && !member?.isFrozen ? 'bg-red-500' : 'bg-blue-400'" />
                {{ member?.isActive ? "Active" : !member?.isActive && !member?.isFrozen ? "Inactive" : "Frozen" }}
              </div>
            </div>
          </div>
        </div>
